...
```{r, echo=FALSE}
datos <- read.csv("C:/Users/coyxz/Downloads/Ejercicio4Ex3.csv")
```
...
En el caso del coeficiente $\tau_{b}$ de Kendall tiene un valor de 0.2491923, mientras que en el coeficiente $\rho_{s}$ de Spearman tenemos un valor de 0.2958182 por lo que en ambos caso tendriamos una relacion monotona positiva. Entonces podriamos decir que a mayor nivel de estudio menor es el impacto de las fakenews  
