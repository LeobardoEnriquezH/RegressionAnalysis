...
Otras transformaciones conocidas de la variable dependiente, podría ser la transformación logarítmica. Veremos si esta transformación mejora los resultados para los supuestos del modelo, ya que es una transformación más sencilla y de más fácil interpretación, pues nos interesan modelos parsimoniosos.  



```{r, echo=FALSE}
modelo3<-lm(data=datos7, I(log(api00)) ~ meals)
#summary(modelo3)
```



En este tenor, haremos las pruebas de cumplimiento de los supuestos. 
