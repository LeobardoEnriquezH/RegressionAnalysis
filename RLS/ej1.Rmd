...
donde $\xi_1, \ldots, \varepsilon_n$ son v.a.i talque $\xi_i \sim N\left(0, \frac{\sigma^2}{w_i}\right)$ $\forall i=1, \ldots, n$
...
$$
III)
Veamos que $\hat{\beta}$ es estimator lineal
$$
\begin{aligned}
& \hat{B}=\frac{\sum X_i Y_i}{\sum_{i=1}^n X_i^2} \quad \text { Sea } \quad c_i=\frac{X_i}{\sum X_i{ }^2} \\
& \rightarrow \hat{B}=\sum_{i=1}^n C_i Y_i \quad \therefore \text { es estimator lineal }
\end{aligned}
$$
